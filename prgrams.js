1. Create a git repository and clone it for the changes and publish the changes using git bash.
...
8. Create 2 JavaScript files. Import one file into another and access a function to sayHello to user.
9. Write a JavaScript console program to find absolute value of a given number usingasync/await.
10. Write a JavaScript console program to find sum of digits of a given number usingasync/await.
...
16. Write a node js program for reading the file and sending the contents as response tothe client request.
...
20. Create Express server listening requests at port 3000. Add different end points toprovide access to the resources.
...
29. Use fetch function to access remote data using the given API
      ...
       Restcountries.com
30. Use fetch function to read the weather data from api “openweathermap.org” anddisplay the details like min_temp,max_temp,avg_temp for a given city
31. Read the weather forecast details for a given city and display details like date and temp in a table
32. Create college database, and products collection and insert the following data in MongoDB
